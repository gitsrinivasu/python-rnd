...
def rotate_right(input, count):
    ...
    return input[-count:]+input[0:len(input)-count] # replace __ with the code
...
-string can be in " " or ''' ''' or ' '
string[:2] means everything before this
-string[2:] meanse everthing after this 2 is also included

-len() is used to find the length and '+' is used for concatination
"""
