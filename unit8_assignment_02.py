    ...
    while True:
        ...
        try:
            ...
            for j in range(4):
                ...
                times = timeit.repeat(stmt='item1(' + str(i) + ')',setup='from unit8_conversion_methods import ' + item + ' as item1',repeat=5, number=1)
...
Create a Timer instance with the given statement, setup code and timer function and run its
 repeat() method with the given repeat count and number executions.
