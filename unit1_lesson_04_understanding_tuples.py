...
def min_max(input):
    ...
    return t  # write a line of code to return containing min and max
...
-tuples are immutable and are represented by paranthesis '()'
-sequences can be converted into tuples and "".join(tuple or list) to convert tuple to a sequence
-min and max can be used to find minimum amd maximum values in the given list or tuple
"""
